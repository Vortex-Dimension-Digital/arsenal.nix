...
| [`gvm-libs`](packages/gvm-libs/package.nix) | Libraries module for the Greenbone Vulnerability Management Solution | 23.11.0 |
| [`httpx`](packages/httpx/package.nix) | Fast and multi-purpose HTTP toolkit | 1.12.0 |
| [`metasploit`](packages/metasploit/package.nix) | Metasploit Framework - a collection of exploits | 6.5.5 |
| [`naabu`](packages/naabu/package.nix) | Fast SYN/CONNECT port scanner | 2.6.1 |
| [`nerva`](packages/nerva/package.nix) | Fingerprinting CLI tool for various protocols | 1.70.0 |
...
| [`nuclei-templates`](packages/nuclei-templates/package.nix) | Templates for the nuclei engine to find security vulnerabilities | 10.4.9 |
